...
async def root():
    return {"status": "online", "message": "Voting System REST API is running."}
...
async def send_otp(request: OtpRequest):
    ...
    message = MessageSchema(
        ...
        body=f"Your OTP code is: {otp}. Please enter this in the app to continue your session.",
    ...
    try:
        ...
        # Fallback for demo: returns 123456 so the app still works if SMTP fails
